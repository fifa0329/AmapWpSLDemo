...
namespace AMap_WP8_Api_Demos_v2._2.Samples
{
    ...
    /// 手势操作
    /// </summary>
    public partial class Gestures7  : PhoneApplicationPage
    {
        AMap amap;
        UiSettings uiset;
        public Gestures7()
        {
            ...
            uiset.ScaleControlEnabled = false;
        ...
        private void scaleEnable(object sender, RoutedEventArgs e)
        {
            uiset.ScaleControlEnabled = true;
        }

        private void scaleDisenable(object sender, RoutedEventArgs e)
        {
            uiset.ScaleControlEnabled = false;
        }
